...
import charaicon from '../assets/charaicon.png'
    ...
    <div className="relative flex flex-col items-center min-h-screen bg-gradient-to-b from-blue-950 to-blue-700 overflow-x-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center w-full mt-10">
        <div className="flex flex-col gap-10 w-full max-w-2xl mb-10">
          ...
          <div
  ref={cardRef}
  className="w-screen mt-40 mb-6 relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] h-170 rounded-lg shadow-xl overflow-hidden"
>
  ...
  />
          ...
          {/* Events */}
          <div className="bg-blue-900 rounded-lg shadow-xl p-8 flex flex-col items-center justify-center cursor-pointer w-screen h-100 mb-6 mt-40 relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
            <h2 className="text-3xl font-semibold text-white mb-2"></h2>
          </div>
          {/* News */}
          <div className="bg-blue-900 rounded-lg shadow-xl p-8 flex flex-col items-center justify-center cursor-pointer w-screen h-100 mb-6 mt-40 relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
            <h2 className="text-3xl font-semibold text-white mb-2"></h2>
